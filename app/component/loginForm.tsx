...
export default function LoginForm({openSignupForm, closeLoginForm}: Props) {
      ...
      >
        ...
        >
          ...
          <p className="text-white/25 text-[0.9rem]">
            Welcome to our platform! Please enter your login details to access your
            account.
          </p>
          <div
            className={`mt-3 w-full  flex-col flex  gap-4`}
          >
            {formMap.map((f, i) => (
              <div
                key={i}
          ...
          <p className="my-2 text-[0.9rem] text-purple-500 underline cursor-pointer" onClick={() => {
            closeLoginForm();
            openSignupForm();
          }}>
